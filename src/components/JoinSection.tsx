...
const JoinSection = () => {
  return (
    <section id="join" className="py-24 px-4 gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          <Button 
            variant="outline" 
            size="xl"
            className="text-xl font-bold bg-card/20 backdrop-blur-sm border-card text-card hover:bg-card hover:text-foreground"
          >
            Bize Ulaşın 💬
          </Button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
          <div className="text-center">
            <p className="text-4xl md:text-5xl font-bold text-card drop-shadow-lg">300+</p>
